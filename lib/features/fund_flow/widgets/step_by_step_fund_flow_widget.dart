...
class StepByStepFundFlowWidget extends StatefulWidget {
  final String title;
  final VoidCallback? onRefresh;

  const StepByStepFundFlowWidget({
    super.key,
  ...
  @override
  State<StepByStepFundFlowWidget> createState() => _StepByStepFundFlowWidgetState();
}

class _StepByStepFundFlowWidgetState extends State<StepByStepFundFlowWidget> {
